...
\contact{malcolm.st.john@usherbrooke.ca \hspace{2cm} \href{https://github.com/ArcticWalrus}{github.com/ArcticWalrus}}
\end{resume_header}
...
\begin{resume_section}{Education}
  \begin{resume_subsection}[Sherbrooke, QC (2017-2021)]{Université de Sherbrooke}
    \begin{subitems}
      ...
      \item Treasurer of the Computer Science club
    \end{subitems}
...
\begin{resume_section}{Projects}
  \begin{resume_subsection}[Summer 2020 - Fall 2021]{Senior design project : Ubivius}
  \begin{subitems}
